...
SELECT id, post_id, user_id, user_nickname, reply_count, comment_content, comment_left, comment_right, comment_parent, isdeleted, created_at, updated_at 
FROM Comment
WHERE id = ?
`
...
select id, post_id, user_id, user_nickname, reply_count, comment_content, comment_left, comment_right, comment_parent, isdeleted, created_at, updated_at from Comment where id = ?
`
...
select c.id, c.post_id, c.user_id, c.user_nickname, c.reply_count, c.comment_content, c.comment_left, c.comment_right, c.comment_parent, c.isdeleted, c.created_at, c.updated_at from Comment c 
where c.post_id = ?
...
select id, post_id, user_id, user_nickname, reply_count, comment_content, comment_left, comment_right, comment_parent, isdeleted, created_at, updated_at from Comment 
